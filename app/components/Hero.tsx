...
export default function Hero() {
    return (
        // A section principal agora ocupa 100% da largura e no mínimo 100% da altura da tela
        <section className="relative isolate w-full min-h-screen flex items-center justify-center overflow-hidden">

            {/* VÍDEO DE BACKGROUND (Agora estica pela tela toda) */}
            <video
                autoPlay
                loop
                muted
            ...
            {/* CONTAINER DO CONTEÚDO (Mantém o limite de largura e o alinhamento original) */}
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 pt-32 md:pt-40 pb-20 flex flex-col items-center text-center">
