...
// Variantes para o contêiner (stagger)
...
// Variantes para os cards (zoom + fade)
...
export default function Solutions() {
    return (
        <section id="solucoes" className="py-24 max-w-7xl mx-auto px-6 overflow-hidden">
            <motion.div
            ...
            >
                ...
                <motion.div
                    ...
                    className="grid md:grid-cols-2 gap-8 items-center bg-zinc-900/40 border border-zinc-800 p-8 md:p-12 rounded-3xl"
                >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {/* E-commerce */}
                    <motion.div variants={cardVariants} className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-3xl hover:border-zinc-700 transition-colors">
