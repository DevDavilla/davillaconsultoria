...
export default function Cases() {
    return (
        <section id="cases" className="py-24 bg-zinc-900/50 border-y border-zinc-800 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <motion.h2
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="text-3xl md:text-4xl font-bold mb-12 text-center text-zinc-50"
                >
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="bg-zinc-950 border border-zinc-800 p-8 rounded-2xl relative transition-colors"
                    >
